...
},
{
  ...
  reading: [
    ...
    "Los métodos de evaluación de competencias incluyen la observación directa del desempeño, la revisión de resultados históricos, la respuesta a preguntas técnicas y la participación en ensayos de aptitud.",
...
// ══ CONTROLLAB adicionales ══
{
  id: "controllab-historia-detalle", title: "Historia detallada de Controllab", level: "Básico", category: "Controllab", emoji: "📜",
  description: "Desde 1977 hasta hoy: hitos, acreditaciones y cultura Controllab.",
  readingTitle: "Lado a lado con vos desde 1977",
  reading: [
    "Controllab fue fundada en 1977 por Marcio Biasoli, con base en una extensa experiencia laboratorial y proyectos pilotos de control de calidad que ya demostraban la necesidad urgente de herramientas externas de evaluación del desempeño analítico en el Brasil. Desde el primer momento, la empresa se orientó a servir a todos los establecimientos que se empeñan en conquistar la calidad técnica.",
    "El camino de acreditaciones voluntarias que Controllab construyó a lo largo de las décadas es la expresión más concreta de sus principios de transparencia, vanguardia, calidad y mejora continua. En agosto de 2001, Controllab se convirtió en el primer Proveedor de Ensayo de Aptitud del Brasil habilitado por ANVISA/REBLAS. En 2003 obtuvo el sello ISO 9001 con las chancelas Bureau Veritas/INMETRO y Bureau Veritas/UKAS.",
    "Las acreditaciones por el CGCRE del INMETRO son otro pilar de la identidad Controllab: en 2002 para calibración volumétrica (CAL0214); en 2011 como proveedora de ensayo de aptitud (PEP003); en 2012 para actividades laboratoriales (CRL0586) y certificada en Buenas Prácticas de Fabricación por ANVISA; y en 2016 como Productora de Material de Referencia Certificado (PMR0009).",
    "Los socios científicos de Controllab incluyen la Sociedad Brasileña de Patología Clínica/Medicina Laboratorial (SBPC/ML) y la Sociedad Brasileña de Medicina Veterinaria (SBMV). Controllab también es miembro de IFCC y EQALM, y tiene relaciones con organismos internacionales como UK Health Security Agency, NCTC, NCPV y NCPF.",
    "El slogan 'Lado a lado con vos' refleja la filosofía de Controllab: no es solo un proveedor de materiales, sino un socio técnico que acompaña al laboratorio en su proceso de mejora continua. Los programas de Ensayo de Aptitud cubren Análisis Clínicas (EAC), Anatomía Patológica, Hemoterapia, Veterinarios, Microbiológicos, Análisis Físico-Químicas, Tuberculosis, Leche Humana y vigiRAM.",
  ],
  vocab: [
    { es: "fundada en 1977 por Marcio Biasoli", pt: "fundada em 1977 por Marcio Biasoli" },
    { es: "habilitado por ANVISA/REBLAS", pt: "habilitado pela ANVISA/REBLAS" },
    { es: "acreditado por CGCRE/INMETRO (PEP003)", pt: "acreditado pelo CGCRE/INMETRO (PEP003)" },
    { es: "Buenas Prácticas de Fabricación (BPF)", pt: "Boas Práticas de Fabricação (BPF)" },
    { es: "socio científico (SBPC/ML, SBMV)", pt: "parceiro científico (SBPC/ML, SBMV)" },
    { es: "lado a lado con vos", pt: "lado a lado com você" },
  ],
  quiz: [
    { question: "¿En qué año fue fundada Controllab y por quién?", options: ["1990 por un grupo de bioquímicos de São Paulo", "1977 por Marcio Biasoli", "2001 cuando fue habilitada por ANVISA", "1965 como parte de la SBPC/ML"], answer: "1977 por Marcio Biasoli" },
    { question: "¿Cuál fue el hito de agosto de 2001?", options: ["Obtención del sello ISO 9001", "Ser el primer Proveedor de EA del Brasil habilitado por ANVISA/REBLAS", "Acreditación como productor de MRC", "Inicio de la expansión a países hispanohablantes"], answer: "Ser el primer Proveedor de EA del Brasil habilitado por ANVISA/REBLAS" },
    { question: "¿Qué certifica la acreditación PEP003 del CGCRE/INMETRO?", options: ["Calibración volumétrica de equipos", "Los servicios de Ensayo de Aptitud de Controllab", "La producción de Materiales de Referencia Certificados", "Las Buenas Prácticas de Fabricación"], answer: "Los servicios de Ensayo de Aptitud de Controllab" },
    { question: "¿Qué certifica la acreditación PMR0009?", options: ["Los programas de calibración volumétrica", "Que Controllab es Productora de Material de Referencia Certificado", "Los programas de ensayo de aptitud clínico", "Las actividades de capacitación del laboratorio"], answer: "Que Controllab es Productora de Material de Referencia Certificado" },
    { question: "¿Cuáles son los socios científicos principales en Brasil?", options: ["ANVISA y INMETRO exclusivamente", "SBPC/ML y SBMV", "Solo la SBPC/ML", "FIOCRUZ y Ministerio de Salud solamente"], answer: "SBPC/ML y SBMV" },
    { question: "¿Qué programas de EA ofrece Controllab además de los clínicos?", options: ["Solo análisis clínicas y veterinarias", "Anatomía Patológica, Hemoterapia, Microbiológicos, Físico-Químicas, Tuberculosis, Leche Humana y vigiRAM", "Solo los requeridos por ANVISA", "Solo los sectores cubiertos por PEP003"], answer: "Anatomía Patológica, Hemoterapia, Microbiológicos, Físico-Químicas, Tuberculosis, Leche Humana y vigiRAM" },
    { question: "¿Qué refleja el slogan 'Lado a lado con vos'?", options: ["Que Controllab tiene presencia en todo Brasil", "Que Controllab es un socio técnico que acompaña al laboratorio en su mejora continua", "Que los programas de EA son de fácil acceso", "Que Controllab tiene el precio más accesible"], answer: "Que Controllab es un socio técnico que acompaña al laboratorio en su mejora continua" },
    { question: "¿Por qué las acreditaciones voluntarias son especialmente significativas para Controllab?", options: ["Porque son más fáciles de obtener que las obligatorias", "Porque demuestran una cultura de transparencia y calidad que va más allá de lo que la ley exige", "Solo porque los clientes las exigen contractualmente", "Porque reducen el costo operativo del programa"], answer: "Porque demuestran una cultura de transparencia y calidad que va más allá de lo que la ley exige" },
  ],
  dictation: "Controllab fue fundada en 1977 por Marcio Biasoli y en 2001 se convirtió en el primer proveedor de ensayo de aptitud del Brasil habilitado por ANVISA y REBLAS.",
},
{
  id: "controllab-id", title: "Índice de Desvio (ID) de Controllab", level: "Avanzado", category: "Controllab", emoji: "📐",
  description: "El indicador de desempeño propio de Controllab: cálculo, interpretación y uso.",
  readingTitle: "¿Por qué Controllab usa el ID?",
  reading: [
    "Controllab utiliza el Índice de Desvio (ID) como indicador principal del desempeño cuantitativo en sus programas de Ensayo de Aptitud (EA). El ID tiene un propósito similar al z-score tradicional, pero con una diferencia conceptual importante: mientras el z-score relativiza el error frente a la variación del grupo comparativo, el ID relativiza el error frente al criterio del propio proveedor.",
    ...
    "La ventaja práctica del ID es que permite comparar el desempeño entre diferentes ensayos de forma directa. Como siempre se relativiza frente al mismo criterio, un ID de 0.8 en glucosa y un ID de 0.8 en hemoglobina tienen exactamente el mismo significado relativo. Con el z-score esto no es posible porque depende de la variación del grupo.",
    "El ID también permite visualizar tendencias: si el ID se acerca progresivamente a 1 o a -1 en corridas sucesivas, es una señal de alerta incluso antes de que el resultado sea inadecuado.",
    "Controllab también disponibiliza el Z-escore del Grupo de Avaliação (GA) en algunos ensayos clínicos, calculado como: Z-escore (GA) = (resultado − média do GA) / desvio padrão do GA. Pero el indicador principal de desempeño es el ID, no el z-score.",
  ],
  vocab: [
    { es: "Índice de Desvio (ID)", pt: "Índice de Desvio (ID)" },
  ...
  quiz: [
    { question: "¿Cuál es la fórmula del Índice de Desvio (ID)?", options: ["ID = resultado / valor alvo", "ID = (resultado − valor alvo) / límite del programa", "ID = (resultado − média) / desvio padrão do grupo", "ID = resultado × límite / valor alvo"], answer: "ID = (resultado − valor alvo) / límite del programa" },
    ...
    { question: "¿Cuál es la diferencia conceptual principal entre el ID y el z-score?", options: ["El ID usa la mediana y el z-score usa la media", "El ID relativiza el error frente al criterio del proveedor; el z-score frente a la variación del grupo comparativo", "El z-score es más preciso que el ID", "Solo difieren en el nombre, el cálculo es idéntico"], answer: "El ID relativiza el error frente al criterio del proveedor; el z-score frente a la variación del grupo comparativo" },
    ...
    { question: "¿Qué señal de alerta puede detectarse con el ID antes de un resultado inadecuado?", options: ["Un ID exactamente igual a 0 en varias corridas", "Un ID que se acerca progresivamente a 1 o a -1 en corridas sucesivas", "Un ID que varía aleatoriamente entre -0.5 y 0.5", "Un ID negativo en todos los resultados"], answer: "Un ID que se acerca progresivamente a 1 o a -1 en corridas sucesivas" },
    { question: "¿Qué es el valor alvo en el programa de Controllab?", options: ["El valor del control interno del laboratorio", "La media o mediana del grupo de evaluación tras el tratamiento estadístico", "El límite máximo de la faixa de avaliação", "El resultado del laboratorio de referencia"], answer: "La media o mediana del grupo de evaluación tras el tratamiento estadístico" },
    { question: "¿El z-score reemplaza al ID como indicador principal en Controllab?", options: ["Sí, el z-score es siempre el indicador principal", "No, el ID es el indicador principal; el z-score del GA es información complementaria en algunos ensayos", "Son equivalentes y el laboratorio elige cuál usar", "Solo el z-score está acreditado por el CGCRE"], answer: "No, el ID es el indicador principal; el z-score del GA es información complementaria en algunos ensayos" },
  ...
  dictation: "El Índice de Desvio de Controllab se calcula dividiendo la diferencia entre el resultado y el valor alvo por el límite del programa: un ID entre menos uno y más uno indica resultado adecuado.",
},
{
  ...
  reading: [
    "Una rodada del Ensayo de Aptitud de Controllab es una ronda completa: desde la distribución de los materiales hasta la emisión del informe de evaluación. Cada rodada tiene una identificación única formada por el mes (tres caracteres) y el año (cuatro dígitos) correspondientes al envío.",
    ...
    "Controllab aplica el tratamiento estadístico con el Grupo Assessor y emite el Relatório de Avaliação con los resultados individuales, el ID de cada ítem, la faixa de avaliação y los comentarios técnicos. El Perfil de Resultados complementa el informe con el resumen estadístico de todos los participantes.",
    "A lo largo del año, el desempeño se acumula en el %A (porcentaje de adecuados). Al final del año, si el laboratorio alcanzó el grau de desempenho mínimo, recibe el Certificado de Proficiência. Para la mayoría de los ensayos el mínimo es 80%; para ensayos críticos de hemoterapia como Anti-HIV es 100%.",
  ],
  vocab: [
  ...
  quiz: [
    ...
    { question: "¿Qué es la Rodada Especial de Controllab?", options: ["Una rodada con materiales más difíciles para laboratorios avanzados", "Una rodada de recuperación en el último trimestre para laboratorios que no alcanzaron el %A mínimo", "Una rodada adicional gratuita para todos los participantes", "Una rodada solo para ensayos de hemoterapia"], answer: "Una rodada de recuperación en el último trimestre para laboratorios que no alcanzaron el %A mínimo" },
  ],
...
},
{
  ...
  reading: [
    "El Sistema Online de Controllab es la plataforma digital a través de la cual los laboratorios participantes interactúan con el programa de Ensayo de Aptitud. Es la herramienta central para el envío de resultados, el acceso a informes, la descarga de documentos y la gestión de los datos del programa.",
    "Cada laboratorio debe designar un administrador del Sistema Online. El administrador tiene acceso completo, puede delegar acceso a otros profesionales del establecimiento y es responsable de enviar los resultados de cada rodada, mantener los datos del sistema analítico actualizados y verificar el cumplimiento de los plazos.",
    "El envío de resultados es la función más crítica. El participante debe seleccionar correctamente el sistema analítico (fabricante del kit, método, equipo, temperatura, unidades) antes de ingresar el resultado. Si el sistema no está disponible, puede completarse manualmente y subirse la documentación en el campo de Pendências.",
