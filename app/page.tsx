...

{
  ...
  quiz: [
    ...
    { question: "¿Qué herramienta de Controllab menciona Lucas para mostrar el valor agregado?", options: ["El certificado de acreditación ISO/IEC 17043", "El Relatorio de Evaluación que muestra la evolución del ID y permite correlacionar con cambios en el proceso", "El catálogo completo de programas disponibles", "El Sistema Online con acceso a todos los informes anteriores"], answer: "El Relatorio de Evaluación que muestra la evolución del ID y permite correlacionar con cambios en el proceso" },
...

{
  ...
  reading: [
    ...
    "— Entendido. Las abordo en orden. Respecto al precio: la diferencia refleja que estamos ofreciendo programas con criterios de evaluación basados y acreditados bajo ISO/IEC 17043, con soporte técnico incluido — no solo materiales. El costo de un resultado incorrecto que lleva a una decisión clínica equivocada es significativamente mayor que esa diferencia del doce por ciento. Puedo dejarle documentado ese análisis para el comité si le parece útil.",
...

{
  ...
  reading: [
    ...
    "El control de calidad en microbiología tiene características propias. Las cepas de referencia ATCC son el estándar para verificar el desempeño del antibiograma: si el halo de inhibición de la cepa ATCC no cae dentro del rango esperado, los resultados de las muestras de pacientes de esa misma corrida deben retenerse hasta identificar la causa. La participación en el Ensayo de Aptitud de Controllab para microbiología permite al laboratorio comparar su desempeño en identificación y antibiograma frente a otros laboratorios que usan métodos similares.",
  ],
  vocab: [
...
<div style={{ minHeight: "100vh", background: C.bg, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24, fontFamily: FONT }}>      <style>{`@import url('https://fonts.googleapis.com/css2?family=Syne:wght@700;800&family=DM+Sans:wght@400;500;600;700&family=DM+Mono:wght@400;500&display=swap'); * { box-sizing: border-box; } input::placeholder { color: ${C.textDim}; } input:focus { border-color: ${C.borderA} !important; outline: none; } ::-webkit-scrollbar { width: 4px; } ::-webkit-scrollbar-thumb { background: rgba(255,255,255,0.1); border-radius: 99px; }`}</style>
  ...
  {currentQuestionIndex > 0 && (
    <button onClick={() => { const prev = currentQuestionIndex - 1; setCurrentQuestionIndex(prev); setSelectedOption(quizAnswers[prev] || ""); setSubmitted(!!quizAnswers[prev]); }} style={btnGhost}>← Anterior</button>
  )}
