    ...
    quiz: [
      {
        ...
        options: [
          ...
          "Una falla en el equipo de refrigeración",
          "Un error en la facturación",
        ],
        answer: "Una desviación en los controles internos",
      },
      {
        question: "¿Qué decisión tomó el equipo como medida preventiva?",
        options: [
          "Suspender temporalmente la liberación de algunos resultados",
          "Cambiar a todo el personal",
          "Descartar todo el equipamiento",
        ],
        answer: "Suspender temporalmente la liberación de algunos resultados",
      },
      {
        question: "¿Por qué es importante identificar tendencias a tiempo?",
        options: [
          "Para evitar errores mayores y proteger la calidad",
          "Para reducir reuniones",
          "Para eliminar controles innecesarios",
        ],
        answer: "Para evitar errores mayores y proteger la calidad",
      },
    ],
    dictation:
      "El equipo detectó una desviación en los controles internos y suspendió temporalmente la liberación de resultados para proteger la calidad del proceso.",
  },
  {
    id: "westgard",
    ...
    quiz: [
      {
        question: "¿Qué observó la analista en el control?",
        options: ["Una caída del sistema", "Un comportamiento inusual", "Una pérdida de datos"],
      ...
      },
      {
        ...
        options: [
          ...
          "Si había que cambiar de laboratorio",
        ],
      ...
      },
      {
        ...
        options: [
          "Tomar decisiones seguras y justificarlas",
          "Evitar todo control",
          "Trabajar sin registros",
        ],
        answer: "Tomar decisiones seguras y justificarlas",
      },
    ],
    dictation:
      "Comprender las reglas de Westgard ayuda a tomar decisiones más seguras y a justificar técnicamente cada acción del laboratorio.",
  },
  {
    id: "trazabilidad",
    ...
    quiz: [
      {
        question: "¿Qué problema apareció en la auditoría?",
        options: ["Faltaban registros intermedios", "Se cortó la luz", "No había clientes"],
        answer: "Faltaban registros intermedios",
      },
      {
        question: "¿Para qué sirve la trazabilidad?",
        options: [
          "Para reducir reuniones",
          "Solo para cumplir documentos",
          "Para reconstruir decisiones y verificar responsabilidades",
        ],
        answer: "Para reconstruir decisiones y verificar responsabilidades",
      },
      {
        question: "¿Qué hizo el área después del análisis?",
        options: ["Actualizó su checklist", "Cerró el sector", "Eliminó registros"],
        answer: "Actualizó su checklist",
      },
    ],
    dictation:
      "La trazabilidad permite reconstruir decisiones, verificar responsabilidades y reducir el riesgo de errores no detectados.",
  },
  {
    id: "validacion",
    ...
    quiz: [
      {
        question: "¿Qué debía demostrar el equipo?",
        options: [
          "Que no hacía falta revisar datos",
          "Que el método era adecuado para el uso previsto",
          "Que el laboratorio era el más grande",
        ],
        answer: "Que el método era adecuado para el uso previsto",
      },
      {
        question: "¿Qué evaluaron durante la validación?",
        options: ["Solo el costo", "Resultados, repeticiones e interferencias", "Solo la velocidad"],
        answer: "Resultados, repeticiones e interferencias",
      },
      {
        question: "Validar un método significa...",
        options: [
          "Comprender cómo responde y sus límites",
          "Llenar una planilla sin analizar",
          "Trabajar sin criterios técnicos",
        ],
        answer: "Comprender cómo responde y sus límites",
      },
    ],
    dictation:
      "Validar un método significa comprender cómo responde, cuáles son sus límites y en qué condiciones ofrece resultados consistentes.",
  },
  {
    id: "muestras",
    ...
    quiz: [
      {
        question: "¿Qué problema tenían algunas muestras al llegar?",
        options: [
          "Estaban congeladas",
          "Venían sin etiqueta o con información incompleta",
          "Eran del tipo equivocado de análisis",
        ],
        answer: "Venían sin etiqueta o con información incompleta",
      },
      {
        question: "¿Qué establece el protocolo de recepción?",
        options: [
          "Criterios claros para aceptar o rechazar muestras",
          "Que toda muestra debe procesarse",
          "Que el cliente nunca se equivoca",
        ],
        answer: "Criterios claros para aceptar o rechazar muestras",
      },
      {
        question: "¿Qué hizo el equipo después del episodio?",
        options: [
          "Mejoró la comunicación y creó un instructivo",
          "Ignoró el problema",
          "Rechazó a todos los nuevos clientes",
        ],
        answer: "Mejoró la comunicación y creó un instructivo",
      },
    ],
    dictation:
      "Cuando una muestra no cumple los criterios de recepción, el analista debe comunicarlo de forma profesional y registrar el motivo del rechazo.",
  },
  {
    id: "indicadores",
    ...
    quiz: [
      {
        question: "¿Qué parecía estable al comienzo de la reunión?",
        options: ["La rotación de personal", "El tiempo medio de respuesta", "El presupuesto anual"],
        answer: "El tiempo medio de respuesta",
      },
      {
        question: "¿Qué propuso la coordinación?",
        options: [
          "Desagregar los datos por distintos criterios",
          "Suspender las reuniones",
          "Eliminar los indicadores",
        ],
        answer: "Desagregar los datos por distintos criterios",
      },
      {
        question: "La idea principal del texto es que...",
        options: [
          "El contexto importa para interpretar los números",
          "Un indicador aislado siempre es suficiente",
          "Los informes deben eliminarse",
        ],
        answer: "El contexto importa para interpretar los números",
      },
    ],
    dictation:
      "Para una buena gestión, es fundamental cruzar datos, comparar tendencias y discutir el significado operativo de cada número.",
  },
  {
    id: "no-conformidades",
    ...
    quiz: [
      {
        question: "¿Por qué el problema se repitió?",
        options: [
          "Por falta de muestras",
          "Porque la acción correctiva anterior no fue real",
          "Por un error del cliente",
        ],
        answer: "Porque la acción correctiva anterior no fue real",
      },
      {
        question: "¿Qué encontraron al analizar la causa raíz?",
        options: [
          "Que era un error individual",
          "Que el procedimiento estaba desactualizado",
          "Que faltaban reactivos",
        ],
        answer: "Que el procedimiento estaba desactualizado",
      },
      {
        question: "¿Qué se programó a los 30 días?",
        options: ["Una reunión social", "Una verificación de eficacia", "Una nueva auditoría externa"],
        answer: "Una verificación de eficacia",
      },
    ],
    dictation:
      "Una acción correctiva debe incluir el análisis de causa raíz, la actualización del procedimiento y una verificación de eficacia posterior.",
  },
  {
    id: "atencion-cliente",
    ...
    quiz: [
      {
        question: "¿Por qué llamó el cliente?",
        options: [
          "Porque perdió la contraseña",
          "Porque no entendía una diferencia en el informe",
          "Porque quería cambiar de proveedor",
        ],
        answer: "Porque no entendía una diferencia en el informe",
      },
      {
        question: "¿Qué hizo primero la analista?",
        options: ["Escuchó la duda completa", "Cortó la llamada", "Envió un correo automático"],
        answer: "Escuchó la duda completa",
      },
      {
        question: "En atención técnica también hay que...",
        options: ["Hablar rápido", "Transmitir claridad y confianza", "Usar solo términos complejos"],
        answer: "Transmitir claridad y confianza",
      },
    ],
    dictation:
      "En atención técnica no alcanza con tener razón: también es necesario explicar con claridad y transmitir confianza.",
  },
  {
    id: "correo-tecnico",
    ...
    quiz: [
      {
        question: "¿Por qué el correo generó confusión?",
        options: [
          "Porque tenía errores técnicos",
          "Porque la redacción era poco clara",
          "Porque lo envió la persona equivocada",
        ],
        answer: "Porque la redacción era poco clara",
      },
      {
        question: "¿Qué incluye la estructura de un buen correo técnico?",
        options: [
          "Solo la información técnica",
          "Saludo, contexto, información, próximos pasos y cierre",
          "Solo el problema y la solución",
        ],
        answer: "Saludo, contexto, información, próximos pasos y cierre",
      },
      {
        question: "¿Cómo respondió el cliente al nuevo correo?",
        options: [
          "Negativamente",
          "Positivamente y agradeció la claridad",
          "No respondió",
        ],
        answer: "Positivamente y agradeció la claridad",
      },
    ],
    dictation:
      "Un correo técnico efectivo tiene saludo profesional, contexto breve, información clara, próximos pasos y cierre cordial.",
  },
  {
    id: "helpdesk",
    ...
    quiz: [
      {
        question: "¿Cuál fue el primer paso del técnico de soporte?",
        options: [
          "Reinstalar el sistema",
          "Clasificar si era un problema generalizado o local",
          "Llamar al proveedor externo",
        ],
        answer: "Clasificar si era un problema generalizado o local",
      },
      {
        question: "¿Qué causó el problema?",
        options: [
          "Una actualización automática con conflicto",
          "Un error del usuario",
          "Una muestra mal procesada",
        ],
        answer: "Una actualización automática con conflicto",
      },
      {
        question: "¿Qué reforzó la experiencia?",
        options: [
          "Que el soporte no es necesario",
          "La importancia de documentar y comunicar incidentes",
          "Que los sistemas nunca fallan",
        ],
        answer: "La importancia de documentar y comunicar incidentes",
      },
    ],
    dictation:
      "Es importante documentar los incidentes técnicos y comunicar el estado de la resolución a todos los usuarios afectados.",
  },
  {
    id: "seguridad-datos",
    ...
    quiz: [
      {
        question: "¿Qué práctica de riesgo se descubrió?",
        options: [
          "Que varios usuarios compartían la misma contraseña",
          "Que apagaban los servidores",
          "Que no usaban el sistema",
        ],
        answer: "Que varios usuarios compartían la misma contraseña",
      },
      {
        question: "¿Qué implementó TI para mejorar la seguridad?",
        options: [
          "Solo cambiar contraseñas",
          "Accesos individuales, contraseñas seguras y doble factor",
          "Cerrar el acceso a todos",
        ],
        answer: "Accesos individuales, contraseñas seguras y doble factor",
      },
      {
        question: "La seguridad de datos protege principalmente...",
        options: [
          "La integridad de los resultados y la confianza del cliente",
          "El servidor físico",
          "El presupuesto del área",
        ],
        answer: "La integridad de los resultados y la confianza del cliente",
      },
    ],
    dictation:
      "La seguridad de los datos protege la integridad de los resultados y la confianza del cliente, y no es solo una exigencia regulatoria.",
  },
  {
    id: "lims",
    title: "Sistema LIMS",
    ...
    quiz: [
      {
        question: "¿Qué queda registrado en el LIMS?",
        options: [
          "Solo el nombre del cliente",
          "Recepción, analista, instrumento, controles y resultado",
          "Solo el resultado final",
        ],
        answer: "Recepción, analista, instrumento, controles y resultado",
      },
      {
        question: "¿Qué permite el LIMS cuando un cliente solicita una revisión?",
        options: [
          "Recuperar toda la información rápidamente",
          "Reiniciar el proceso desde cero",
          "Nada, hay que buscar en papel",
        ],
        answer: "Recuperar toda la información rápidamente",
      },
      {
        question: "Un LIMS bien configurado...",
        options: [
          "Solo sirve para facturación",
          "Reduce errores y facilita la trazabilidad",
          "Reemplaza al analista",
        ],
        answer: "Reduce errores y facilita la trazabilidad",
      },
    ],
    dictation:
...
async function saveRemoteState(state: AppState): Promise<void> {
  ...
  const { error } = await supabase.from("aula_controllab_state").upsert(payload, {
    onConflict: "id",
  });
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const bootstrap = async () => {
      try {
        ...
        if (remote) {
          setAppState({
            students: Array.isArray(remote.students) && remote.students.length ? remote.students : defaultStudents,
            currentStudentId: null,
  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(async () => {
      try {
        ...
        setSaveError("No se pudo guardar en la nube.");
      }
    }, 350);
  ...
  const filteredModules =
    activeCategory === "Todos" ? MODULES : MODULES.filter((m) => m.category === activeCategory);
  ...
  const login = () => {
    const found = appState.students.find(
      (s) => normalize(s.name) === normalize(loginName) && normalize(s.code) === normalize(loginCode)
    );
  ...
  const resetCurrentModule = () => {
    ...
    const ok = window.confirm(
      `¿Querés reiniciar el módulo "${selectedModule.title}" para ${currentStudent.name}?`
    );
    if (!ok) return;
    ...
    setAppState((prev) => {
      ...
      return {
        ...
        progress: {
          ...prev.progress,
          [currentStudent.id]: newProgress,
        },
        dictations: {
          ...prev.dictations,
          [currentStudent.id]: newDictations,
        },
      };
    });
  ...
  const resetStudentAllModules = () => {
    if (!currentStudent) return;

    const ok = window.confirm(`¿Querés reiniciar TODOS los módulos de ${currentStudent.name}?`);
    if (!ok) return;
  ...
  const resetAllStudentsEverything = () => {
    const ok = window.confirm(
      "¿Querés borrar TODO el progreso y todos los dictados de TODOS los alumnos y empezar desde cero?"
    );
    if (!ok) return;
  ...
  const removeStudent = (studentId: string) => {
    ...
    const ok = window.confirm(`¿Querés eliminar a ${student?.name || "este alumno"}?`);
    if (!ok) return;
    ...
    return (
      <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center px-6">
        <div className="text-center">
          <div className="text-2xl font-bold">Cargando Aula Controllab...</div>
          <div className="text-slate-400 mt-2 text-sm">Sincronizando progreso en la nube</div>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center px-6">
        <div className="max-w-xl text-center">
          <div className="text-2xl font-bold text-rose-400">Error al cargar los datos</div>
          <p className="text-slate-300 mt-3">
            Revisá las variables de Supabase y la tabla <code>aula_controllab_state</code>.
          </p>
        </div>
      </div>
    );
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <div className="glass rounded-3xl p-8 md:p-10 glow">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight">
                Aula
                <br />
                <span className="accent">Controllab</span>
              </h1>
              <p className="mt-4 text-slate-300 leading-7">
                Plataforma de español técnico para el equipo Controllab. El progreso queda guardado en la nube.
              </p>

              <div className="mt-8 grid grid-cols-2 gap-4">
                {[
                  { num: MODULES.length, label: "Módulos", sub: "Lab · Gestión · TI · Com." },
                  { num: appState.students.length, label: "Alumnos", sub: "Guardados en nube" },
                  { num: "☁️", label: "Progreso", sub: "Multidispositivo" },
              ...
              <div className="mt-8 glass rounded-2xl p-5">
                <div className="text-xs mono text-slate-400 mb-3 tracking-widest">ACCESO DE EJEMPLO</div>
                <div className="text-slate-200 text-sm leading-7">
                  <div>
                    <strong>Usuario:</strong> Franco
                  </div>
                  <div>
                    <strong>Contraseña:</strong> Franco
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass rounded-3xl p-8 md:p-10">
              ...
              <p className="mt-2 text-slate-400 text-sm">
                Usá tu usuario y contraseña. El avance queda guardado aunque entres desde otro dispositivo.
              </p>

              <div className="mt-8 space-y-4">
                <div>
                  <label className="block text-sm text-slate-300 mb-2 font-medium">Usuario</label>
                  <input
                    value={loginName}
                    onChange={(e) => setLoginName(e.target.value)}
                    onKeyDown={(e) => e.key === "Enter" && login()}
                    placeholder="Ej: Franco"
                    className="w-full rounded-xl bg-slate-800 border border-slate-700 text-white px-4 py-3 transition"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onKeyDown={(e) => e.key === "Enter" && login()}
                    placeholder="Ej: Franco"
                    className="w-full rounded-xl bg-slate-800 border border-slate-700 text-white px-4 py-3 mono transition"
                  />
                </div>
              ...
              <div className="mt-8 glass rounded-2xl p-5">
                ...
                <button
                  onClick={() => setShowProfessorPanel((v) => !v)}
                ...
                {showProfessorPanel && (
                  <div className="mt-4 space-y-3">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl bg-slate-800 border border-slate-700 text-white px-4 py-3 text-sm mono"
                    />
                    <button
                      onClick={addStudent}
                      className="w-full rounded-xl border border-slate-600 text-slate-200 px-4 py-2.5 text-sm hover:bg-slate-700 transition"
                    >
                      + Agregar alumno
                    </button>
                    <button
                      onClick={resetAllStudentsEverything}
                      className="w-full rounded-xl border border-rose-500/30 bg-rose-500/10 text-rose-300 px-4 py-2.5 text-sm hover:bg-rose-500/20 transition"
                    >
                      Reset total de todos los alumnos
                    </button>
                  </div>
                )}
              </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <header className="sticky top-0 z-50 glass-dark border-b border-white/5">
        <div className="max-w-screen-2xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-3 ml-4">
              ...
              <div className="glass rounded-xl px-4 py-2 text-sm">
                ...
                <span className="font-bold">
                  {completedModules}
                  <span className="text-slate-500">/{MODULES.length}</span>
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 flex-wrap justify-end">
            <button
              onClick={resetStudentAllModules}
              className="glass rounded-xl px-4 py-2.5 text-sm text-amber-300 hover:bg-white/10 transition"
            >
              Reset mis módulos
            </button>
            <button
      ...
      <div className="max-w-screen-2xl mx-auto px-6 py-8">
        {saveError && (
          <div className="mb-4 rounded-2xl border border-amber-500/30 bg-amber-500/10 text-amber-300 px-4 py-3 text-sm">
            {saveError}
          </div>
        )}
              ...
              <div className="flex gap-2 flex-wrap">
                {(["progress", "students", "dictations"] as const).map((tab) => (
                  <button
                    ...
                    className={`section-tab ${teacherTab === tab ? "active" : ""}`}
                  >
                    {tab === "progress"
                      ? "📊 Progreso"
                      : tab === "students"
                ...
                <button
                  onClick={resetAllStudentsEverything}
                  className="rounded-xl px-4 py-2 text-sm font-semibold bg-rose-500/15 text-rose-300 border border-rose-400/20 hover:bg-rose-500/25 transition"
                >
                  Reset total
                </button>
              </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-white/5 text-slate-400">
                      ...
                      {MODULES.map((m) => (
                        <th key={m.id} className="text-center px-2 py-3 font-semibold text-xs" title={m.title}>
                          {m.emoji}
                        </th>
                      ))}
                  ...
                  <tbody>
                    {professorRows.map((row, i) => (
                      ...
                      >
                        ...
                        {MODULES.map((m) => {
                          ...
                          return (
                            <td key={m.id} className="text-center px-2 py-3">
                              {p ? (
                                <span className="accent font-bold mono text-xs">
                                  {p.score}/{p.total}
                                </span>
                              ) : (
                        ...
                        <td className="text-center px-4 py-3 font-bold accent mono">
                          {row.bestScore}/{totalQuestions}
                        </td>
                        <td className="text-center px-4 py-3">
                          <span
                            className={`text-xs font-bold px-2 py-1 rounded-full ${
                              row.completedMods === MODULES.length
                  ...
                  <tbody>
                    {professorRows.map((row, i) => (
                      ...
                      >
                        ...
                        <td className="text-center px-4 py-3 font-bold mono accent">
                          {row.dictAvg != null ? `${row.dictAvg}%` : "—"}
                        </td>
                      </tr>
                    ))}
                  </tbody>
                ...
                <div className="glass-dark rounded-2xl p-5">
                  ...
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl bg-slate-800 border border-slate-700 text-white px-4 py-3 text-sm mono"
                    />
                    <button onClick={addStudent} className="btn-accent w-full px-4 py-3 text-sm">
                      + Agregar
                    </button>
                    <button
                      onClick={resetAllStudentsEverything}
                      className="w-full rounded-xl border border-rose-500/30 bg-rose-500/10 text-rose-300 px-4 py-3 text-sm hover:bg-rose-500/20 transition"
                    >
                      Resetear todos los alumnos
                    </button>
                  </div>
                </div>
        ...
        <div className="flex gap-2 mb-6 overflow-x-auto pb-1">
          {CATEGORIES.map((cat) => (
            <button
              ...
              className={`section-tab whitespace-nowrap ${activeCategory === cat ? "active" : ""}`}
            >
              {cat}
            </button>
          ))}
          ...
          {filteredModules.map((module) => {
            ...
            return (
              <button
                ...
                className={`module-card glass rounded-2xl p-4 text-left border ${
                  active ? "active" : "border-white/5"
                }`}
              >
                ...
                {prog && (
                  <div className="mt-2 progress-bar">
                    <div
                      ...
                      style={{ width: `${Math.round((prog.score / prog.total) * 100)}%` }}
                    />
                  </div>
                )}
              </button>
          ...
          <div className="space-y-6">
            <div className="glass rounded-3xl p-6">
              <div className="flex items-start justify-between gap-4 flex-wrap">
                <div>
                  <div className="mono text-xs text-slate-400 tracking-widest mb-1">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <span className={`text-xs px-3 py-1.5 rounded-full font-bold ${LEVEL_COLOR[selectedModule.level]}`}>
                    {selectedModule.level}
                  </span>

                  <div className="glass rounded-xl px-4 py-2 text-sm">
                    <span className="text-slate-400">Mejor: </span>
                    <span className="font-bold accent mono">
                      {moduleProgress.score}/{moduleProgress.total}
                    </span>
                  </div>
              ...
              <div className="glass rounded-3xl p-6 md:p-8">
                <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
                  ...
                  <button
                    ...
                    className="glass rounded-xl px-4 py-2.5 text-sm text-slate-300 hover:text-white hover:bg-white/10 transition flex items-center gap-2"
                  >
                ...
                <div className="space-y-5">
                  {selectedModule.reading.map((para, i) => (
                    <p key={i} className="text-slate-200 leading-8 text-[15px]">
                      {para}
                    </p>
                  ))}
                </div>
              ...
              <div className="glass rounded-3xl p-6 md:p-8">
                ...
                <div className="progress-bar mb-6">
                  <div
                    className="progress-fill"
                    style={{
                      width: `${((currentQuestionIndex + (submitted ? 1 : 0)) / selectedModule.quiz.length) * 100}%`,
                    }}
                  />
                </div>
                ...
                <div className="mt-6 flex items-center justify-between flex-wrap gap-4">
                    ...
                    {submitted ? (
                      isCorrect ? (
                        ...
                        <span className="text-rose-400">
                          ...
                          <strong className="text-white">{currentQuestion.answer}</strong>
                        </span>
                      )
                    ) : (
                  ...
                  {!submitted ? (
                    <button
                      ...
                      className="btn-accent px-6 py-3 text-sm disabled:opacity-40 disabled:cursor-not-allowed"
                    >
                      Comprobar
                    </button>
                  ) : (
            ...
            {activeSection === "dictation" && (
              <div className="glass rounded-3xl p-6 md:p-8">
                ...
                <p className="text-slate-400 text-sm mb-5 leading-6">
                  Escuchá el audio y escribí la frase completa en español. Podés reproducirlo las veces que quieras.
                </p>
                ...
                <textarea
                  ...
                  className="w-full rounded-2xl bg-slate-800 border border-slate-700 text-white px-5 py-4 text-sm leading-7 resize-none"
                />

                <button onClick={checkDictation} className="btn-accent mt-4 px-6 py-3 text-sm">
                  Corregir dictado
                </button>
              ...
              <div className="glass rounded-3xl p-6 md:p-8">
                ...
                <div className="grid gap-3 md:grid-cols-2">
                  {selectedModule.vocab.map((item) => (
                    <div
                      key={item.es}
                      className="glass-dark rounded-2xl px-5 py-4 flex justify-between items-center gap-4"
                    >
                      <div>
          ...
          <aside className="space-y-5">
                ...
                {MODULES.map((m) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {p ? (
                        <span className="mono text-xs font-bold accent whitespace-nowrap">
                          {p.score}/{p.total}
                        </span>
                      ) : (
            ...
            <div className="glass rounded-3xl p-6">
              ...
              <p className="text-sm text-slate-300 leading-6">
                💡 Cuando uses términos técnicos en español con un cliente, recordá que la{" "}
                <span className="accent font-semibold">claridad</span> siempre es más importante que la complejidad
                del vocabulario.
              </p>
            </div>
          </aside>
