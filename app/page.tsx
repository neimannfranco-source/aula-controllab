...

{
  ...
  quiz: [
    ...
    { question: "¿Qué estrategia de cierre usa Lucas al final de la conversación?", options: ["Pedir que Rodrigo firme el contrato en esa misma reunión", "Ofrecer una rodada piloto gratuita sin presión para que Rodrigo evalúe por sí mismo", "Ofrecer un descuento del 20% en el primer año", "Proponer una visita a las instalaciones de Controllab en Brasil"], answer: "Ofrecer una rodada piloto gratuita sin presión para que Rodrigo evalúe por sí mismo" },
...
},
{
  ...
  reading: [
    "— Buenos días, habla Mariana Souza de Controllab. ¿Estoy hablando con el Dr. Ramírez?\n— Sí, soy yo. Buenos días, Mariana. ¿En qué le puedo ayudar?\n— Le llamo porque notamos que su laboratorio recibió el informe de la última rodada del programa de bioquímica y quería saber si tiene alguna duda sobre los resultados.",
  ...
  quiz: [
    ...
    },
    {
      ...
      options: ["Enviando un correo a Controllab explicando lo que hizo", "Mostrando que el resultado mejoró en la próxima rodada del EA", "Repitiendo el análisis con la misma muestra del EA", "Cambiando de proveedor de reactivos inmediatamente"],
      answer: "Mostrando que el resultado mejoró en la próxima rodada del EA",
    },
    {
    ...
    },
    {
      ...
      options: ["Solo el resultado de adecuado o inadecuado", "El ID concreto (1.3), el valor alvo (95 mg/dL) y el resultado del laboratorio (108 mg/dL)", "Solo el nombre del ensayo y la fecha de la rodada", "El número de participantes del grupo y el CV del grupo"],
...
},
{
  ...
  reading: [
    ...
    "La visualización de tendencias a lo largo de múltiples rodadas es uno de los usos más valiosos del Perfil de Resultados. Si el ID de un ensayo se mantiene consistentemente positivo en varias rodadas consecutivas —aunque siempre dentro del criterio de aceptación— eso indica un error sistemático leve que vale la pena investigar antes de que supere el límite. El Perfil de Resultados convierte datos de rodadas individuales en una herramienta de gestión longitudinal.",
...
},
{
  ...
  reading: [
    ...
    "El cierre formal de la investigación requiere un registro documentado que incluya: el resultado inadecuado y su ID, la causa identificada, las acciones correctivas implementadas y la evidencia de mejora en rodadas posteriores. Este registro es parte del sistema de calidad del laboratorio y puede ser solicitado en auditorías de acreditación como evidencia del uso efectivo del EA como herramienta de mejora continua.",
  ],
  vocab: [
  ...
  quiz: [
    ...
    { question: "¿Cómo demuestra el laboratorio mejora tras implementar una acción correctiva por un inadecuado?", options: ["Solo actualizando el procedimiento escrito", "Mostrando resultados adecuados en rodadas posteriores del mismo ensayo, visibles en el Perfil de Resultados", "Solo con una nota del director técnico en el sistema de calidad", "Solo si la acción correctiva fue validada por Controllab"], answer: "Mostrando resultados adecuados en rodadas posteriores del mismo ensayo, visibles en el Perfil de Resultados" },
  ...
  dictation: "Un resultado inadecuado en el EA debe investigarse sistemáticamente: caracterizar el error, identificar la causa raíz, implementar una acción correctiva y documentar la mejora en rodadas posteriores.",
},
{
